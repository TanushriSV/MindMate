    ...
    <div className="relative min-h-screen flex flex-col items-center justify-center ambient-glow px-6 md:px-16 overflow-hidden">
      ...
      >
        ...
        <div className="space-y-4">
          <h1 className="text-4xl md:text-5xl font-bold text-primary tracking-tight">{t('splash.brand')}</h1>
        ...
        <div className="mt-12 flex items-center gap-2 text-outline">
          <Sparkles size={18} />
          <span className="text-xs font-bold tracking-widest uppercase">{t('splash.aiPowered')}</span>
        </div>
      </motion.div>
