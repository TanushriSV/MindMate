...
export default function Profile({ onSignOut }: ProfileProps) {
  ...
  const achievements = [
    { id: 1, title: 'Early Riser', sub: '5 sessions before 8AM', completed: true },
    { id: 2, title: 'Heartful', sub: 'Shared 10 reflections', completed: true },
    { id: 3, title: 'Deep Focus', sub: '20min uninterrupted', completed: true },
    { id: 4, title: 'Zen Master', sub: 'Coming soon', completed: false },
  ];
    ...
    <div className="max-w-4xl mx-auto py-8 px-2 space-y-12 pb-16 relative">
      ...
      <section className="space-y-6 relative">
        <div className="flex justify-between items-end px-2">
          ...
          <button 
            onClick={() => triggerTooltip('achievements')}
        ...
        <AnimatePresence>
          {activeTooltip === 'achievements' && (
            <motion.div 
              ...
              className="absolute top-2 right-2 bg-primary/95 text-white py-2 px-4 rounded-xl text-center font-bold text-xs calm-shadow z-20"
            >
              Achievements dashboard coming soon!
            </motion.div>
          )}
        </AnimatePresence>
      </section>
