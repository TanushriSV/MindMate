...
fun SettingsNotificationsScreen(onNavigateBack: () -> Unit) {
    Column(
        ...
        Row(verticalAlignment = Alignment.CenterVertically) {
            ...
            Text("SettingsNotifications", style = MaterialTheme.typography.titleLarge, fontWeight = FontWeight.Bold)
        }
        ...
        Column(
            ...
            Text(
                "The SettingsNotifications feature is currently under construction.",
